...
public class MonthView extends ViewGroup {
    ...
    public static List<DateBean>  mDotList = new ArrayList<>();

    public static void setmDotList(List<DateBean> mDotList) {
        MonthView.mDotList = mDotList;
    }
    ...
    public void setDateList(List<DateBean> dates, int currentMonthDays) {
        ...
        for (int i = 0; i < dates.size(); i++) {
            ...
            if (item_layout != 0 && calendarViewAdapter != null) {
                ...
                imageView = view.findViewById(R.id.solar_image);
            }
            ...
            Drawable bottomDraw = getResources().getDrawable(R.drawable.dothot);
//            bottomDraw.setBounds(0,0,bottomDraw.getMinimumWidth(),bottomDraw.getMinimumHeight());
            bottomDraw.setBounds(0,0,bottomDraw.getIntrinsicWidth(),bottomDraw.getIntrinsicHeight());
            if (isin(date)){
//                solarDay.setCompoundDrawables(null,null,null,bottomDraw);
                imageView.setVisibility(VISIBLE);
//                solarDay.setCompoundDrawablesWithIntrinsicBounds(null,null,null,bottomDraw);
            }else {
                imageView.setVisibility(INVISIBLE);
            }
            //note

            Log.e("111", "setDateList: " + Arrays.toString(date.getSolar()));
    ...
    private boolean isin(DateBean date) {
        int[] solar = date.getSolar();
        boolean flag = false;
        Log.e("111", "isin: " + mDotList );
        for(DateBean dateBean : mDotList){
            int[] dotSolar = dateBean.getSolar();
            if (solar != null && dotSolar != null && solar[0] == dotSolar[0] && solar[1] == dotSolar[1] && solar[2] == dotSolar[2]){
                Log.e("111", "isin: " + Arrays.toString(dotSolar));
                flag = true;
            }
        }
        return flag;
